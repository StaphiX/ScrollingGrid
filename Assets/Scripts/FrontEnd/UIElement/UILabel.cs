...
public class UILabel : FLabel 
{
    ...
    public UILabel(string fontName, string text)
        : base(fontName, text)
    {

    }

    public UILabel(string fontName, string text, FTextParams textParams)
        : base(fontName, text, textParams)
    {
